...
===============
*/
idRenderModel *	idRenderModelSprite::InstantiateDynamicModel( const struct renderEntity_t *renderEntity, const struct viewDef_t *viewDef, idRenderModel *cachedModel ) {
