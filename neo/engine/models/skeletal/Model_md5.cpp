...
====================
*/
void idRenderModelMD5Instance::UpdateSurfaceGPU(struct deformInfo_s* deformInfo, const const renderEntity_t* ent, idModelSurface* surf, const idMaterial* shader) {
	int i, base;
	srfTriangles_t* tri;
